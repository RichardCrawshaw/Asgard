...
/*	This file is automatically generated by a T4 template from a data file.
	...
	It was last generated at 12/27/2021 13:50:07.
 ...
 *	*/
	...
	[OpCode(
		...
		Number = 63, 
		Priority = 3)]
	public partial class ExtendedOpcodeWithNoAdditionalBytes : OpCodeData1, // 0x3F
		IExtendedOpcodeWithNoAdditionalBytes
	{
		#region Fields
		...
		public const OpCodeGroup GROUP = OpCodeGroup.General;
		public const string NAME = "Extended opcode with no additional bytes";
		...
		public ExtendedOpcodeWithNoAdditionalBytes(ICbusMessage cbusMessage) : base(cbusMessage) { }
		public ExtendedOpcodeWithNoAdditionalBytes() : base(CbusMessage.Create(new byte[] {63})) {}
	...
	[OpCode(
		...
		Number = 95, 
		Priority = 3)]
	public partial class ExtendedOpcodeWith1AdditionalByte : OpCodeData2, // 0x5F
		IExtendedOpcodeWith1AdditionalByte
	{
		#region Fields
		...
		public const OpCodeGroup GROUP = OpCodeGroup.General;
		public const string NAME = "Extended opcode with 1 additional byte";
		...
		public ExtendedOpcodeWith1AdditionalByte(ICbusMessage cbusMessage) : base(cbusMessage) { }
		public ExtendedOpcodeWith1AdditionalByte() : base(CbusMessage.Create(new byte[] {95})) {}
	...
	[OpCode(
		...
		Number = 127, 
		Priority = 3)]
	public partial class ExtendedOpcodeWith2AdditionalBytes : OpCodeData3, // 0x7F
		IExtendedOpcodeWith2AdditionalBytes
	{
		#region Fields
		...
		public const string DESCRIPTION = "Used if the basic set of 32 OPCs is not enough. Allows an additional 256 opcodes.";
		public const OpCodeGroup GROUP = OpCodeGroup.General;
		public const string NAME = "Extended opcode with 2 additional bytes";
		...
		public ExtendedOpcodeWith2AdditionalBytes(ICbusMessage cbusMessage) : base(cbusMessage) { }
		public ExtendedOpcodeWith2AdditionalBytes() : base(CbusMessage.Create(new byte[] {127})) {}
	...
	[OpCode(
		...
		Number = 131, 
		Priority = 2)]
	public partial class WriteCbBitInOpsMode : OpCodeData4, // 0x83
		IWriteCbBitInOpsMode
	{
		#region Fields
		...
		public const OpCodeGroup GROUP = OpCodeGroup.DCC;
		public const string NAME = "Write CB (bit) in OPS mode";
		...
		public WriteCbBitInOpsMode(ICbusMessage cbusMessage) : base(cbusMessage) { }
		public WriteCbBitInOpsMode() : base(CbusMessage.Create(new byte[] {131})) {}
	...
	[OpCode(
		...
		Number = 159, 
		Priority = 3)]
	public partial class ExtendedOpcodeWith3AdditionalBytes : OpCodeData4, // 0x9F
		IExtendedOpcodeWith3AdditionalBytes
	{
		#region Fields
		...
		public const string DESCRIPTION = "Used if the basic set of 32 OPCs is not enough. Allows an additional 256 opcodes.";
		public const OpCodeGroup GROUP = OpCodeGroup.General;
		public const string NAME = "Extended opcode with 3 additional bytes";
		...
		public ExtendedOpcodeWith3AdditionalBytes(ICbusMessage cbusMessage) : base(cbusMessage) { }
		public ExtendedOpcodeWith3AdditionalBytes() : base(CbusMessage.Create(new byte[] {159})) {}
	...
	[OpCode(
		...
		Number = 255, 
		Priority = 3)]
	public partial class ExtendedOpcodeWith6DaBytes : OpCodeData7, // 0xFF
		IExtendedOpcodeWith6DaBytes
	{
		#region Fields
		...
		public const string DESCRIPTION = "Used if the basic set of 32 OPCs is not enough. Allows an additional 256 opcodes.";
		public const OpCodeGroup GROUP = OpCodeGroup.General;
		public const string NAME = "Extended opcode with 6 da bytes";
		...
		public ExtendedOpcodeWith6DaBytes(ICbusMessage cbusMessage) : base(cbusMessage) { }
		public ExtendedOpcodeWith6DaBytes() : base(CbusMessage.Create(new byte[] {255})) {}
