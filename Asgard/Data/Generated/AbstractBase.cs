...
/*	This file is automatically generated by a T4 template from a data file.
	...
	It was last generated at 04/03/2022 15:16:48.
 ...
 *	*/
	...
	public abstract partial class OpCodeData :
		ICbusOpCode
	{
        public static bool IsOpCode(byte data)
        {
            return data switch
            {
                0x00 => true,
		...
		{
            if (message.Length == 0)
                throw new Exception("Supplied message contains no data.");

            if (message is not ICbusStandardMessage standardMessage)
                throw new Exception("Supplied message is not a Standard Message.");

			return Create(standardMessage);
		}

		public static OpCodeData Create(ICbusStandardMessage message)
		{
			if (message.Length == 0)
				throw new Exception("Supplied message contains no data.");
	...
	public abstract partial class OpCodeData0 : OpCodeData
	{
		...
		protected OpCodeData0(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData1 : OpCodeData
	{
		...
		protected OpCodeData1(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData2 : OpCodeData
	{
		...
		protected OpCodeData2(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData3 : OpCodeData
	{
		...
		protected OpCodeData3(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData4 : OpCodeData
	{
		...
		protected OpCodeData4(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData5 : OpCodeData
	{
		...
		protected OpCodeData5(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData6 : OpCodeData
	{
		...
		protected OpCodeData6(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
	...
	public abstract partial class OpCodeData7 : OpCodeData
	{
		...
		protected OpCodeData7(ICbusStandardMessage cbusMessage) : base(cbusMessage) { }
	}
